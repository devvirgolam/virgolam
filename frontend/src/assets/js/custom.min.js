...
document.getElementsByClassName("page-wrapper")[0].style =
  "padding-top:" +
...
$(".historystep-btn").on("click", function () {
  ...
  $("#history-modal")
    .find(".history-prev")
    .attr("data-history-current", getcnumber);
  $("#history-modal")
    .find(".history-next")
    .attr("data-history-current", getcnumber);
  $("#history-modal")
    .find(".history-prev")
    .attr("data-history-prev", getcnumber - 1);
  $("#history-modal")
    .find(".history-next")
    .attr("data-history-next", Number(getcnumber) + 1);
...
$(".history-prev").on("click", function () {
  ...
  $("#history-modal")
    .find(".history-next")
    .attr("data-history-current", getprevnumber);
  $("#history-modal")
    .find(".history-next")
    .attr("data-history-next", Number(getprevnumber) + 1);

  var getstatusimage = $("#historystep" + getcnumber).attr("data-image");
  var getstatuslogo = $("#historystep" + getcnumber)
    .find(".historystep-logo")
    .attr("src");
  var getstatusdate = $("#historystep" + getcnumber)
    .find(".historystep-date")
    .text();
...
$(".history-next").on("click", function () {
  ...
  $("#history-modal")
    .find(".history-prev")
    .attr("data-history-current", getnextnumber);
  $("#history-modal")
    .find(".history-prev")
    .attr("data-history-prev", Number(getnextnumber) - 1);
